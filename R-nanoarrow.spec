...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/nanoarrow_0.6.0-1.tar.gz
...
%package dev
Summary: dev components for the R-nanoarrow package.
Group: Development
Requires: R-nanoarrow-lib = %{version}-%{release}
Provides: R-nanoarrow-devel = %{version}-%{release}
Requires: R-nanoarrow = %{version}-%{release}

%description dev
dev components for the R-nanoarrow package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744995754
...
/usr/lib64/R/library/nanoarrow/tests/testthat/_snaps/array.md
...
/usr/lib64/R/library/nanoarrow/tests/testthat/test-ipc.R
...
/usr/lib64/R/library/nanoarrow/tests/testthat/test-vctr.R
...
/V4/usr/lib64/R/library/nanoarrow/libs/nanoarrow.so
/VA/usr/lib64/R/library/nanoarrow/libs/nanoarrow.so
